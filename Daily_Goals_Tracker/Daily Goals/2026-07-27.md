...
- [x] 🎯 **The Target [50 XP]:** 
	- [x] migrate the vite from v5 to v6
...
- [ ] 🧠 **Deep Work [15 XP]:** 
	...
	- [x] Research for the vite package manager upgrade issues.
	- [x] setup the BE in new laptop.
- [ ] ⚡ **Momentum [15 XP]:** 
	- [ ] Reply to Maciej Mail.
	- [ ] Create the message for the caveman skill.
- [ ] 🌱 **Growth [15 XP]:** 
	- [x] Watch one stock market video 
	- [ ] wash the shoes
